...
export const timezoneOptionList = [
  ...
  {
    label: "Europe",
    options: europeTimeZone,
  },
  {
    label: "Canada",
    options: canadaTimeZone,
  },
  {
    label: "Africa",
    options: africaTimeZone,
  },
  {
    label: "America",
    options: americaTimeZone,
  },
  {
    label: "Antarctica",
    options: antarcticaTimeZone,
  },
  {
    label: "Arctic",
    options: arcticTimeZone,
  },
  {
    label: "Asia",
    options: asiaTimeZone,
  },
  {
    label: "Atlantic",
    options: atlanticTimeZone,
  },
  {
    label: "Australia",
    options: australiaTimeZone,
  },
  {
    label: "Brazil",
    options: brazilTimeZone,
  },
  {
    label: "Chile",
    options: chileTimeZone,
  },
  {
    label: "ETC",
    options: etcTimeZone,
  ...
  {
    label: "Indian",
    options: indianTimeZone,
  },
  {
    label: "Mexico",
    options: mexicoTimeZone,
  },
  {
    label: "Pacific",
    options: pacificTimeZone,
  },
  {
    label: "Other",
    options: otherTimeZone,
  },
];
...
export const user1 = {
  ...
  firstName: "Jim",
  lastName: "John",
  profile_picture: "https://avatar.iran.liara.run/public/boy?username=Ash",
  email: "jim@example.com",
  durations: durationOptionList,
  communicationType: communicationTypeOptionList,
  availabilityHour: defaultAvailabilityWindow,
  timeZone: {
    label: "EST",
    value: "EST",
  },
...
export const user2 = {
  ...
  firstName: "Max",
  lastName: "Holly",
  profile_picture: "https://loremflickr.com/250/250/dog",
